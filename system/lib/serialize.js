 ...
 *  ReDeveloped By Rasya R. @chocopys
 *  https://github.com/DikaArdnt
 *  https://github.com/Rasya25
                    ...
                    viewOnceMessage: {
                        message: {
                            ...
                            interactiveMessage: proto.Message.InteractiveMessage.create({
                                ...
                                footer: proto.Message.InteractiveMessage.Footer.create({ text: footer || "(c) 2024 PycosAI" }),
                    ...
                    viewOnceMessage: {
                        message: {
                            ...
                            interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                                footer: proto.Message.InteractiveMessage.Footer.create({ text: "(c) 2024 PycosAI" }),
        ...
        downloadMediaMessage: {
            async value(message, filename) {
                let media = await downloadMediaMessage(
                    ...
                    {},
                    {
                        logger: pino({ timestamp: () => `,"time":"${new Date().toJSON()}"`, level: "fatal" }).child({ class: "pycos" }),
    ...
    try {
        ...
        m.reply = async (text, options = {}) => {
            if (typeof text === "string") {
                return await client.sendMessage(m.from, { text, ...options, contextInfo: { forwardedNewsletterMessageInfo: { newsletterName: "(c) 2024 PycosAI", newsletterJid: "120363182916458068@newsletter" } } }, { quoted: m, ephemeralExpiration: m.expiration, ...options });
